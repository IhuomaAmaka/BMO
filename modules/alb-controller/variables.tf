...
variable "cluster_identity_oidc_issuer" {
  type        = string
  description = "The OIDC IdIdentity issuer for the cluster."
}
...
variable "helm_chart_version” {
  type        = string
  default     = "1.5.3"
  description = "ALB EontrollerHelm chart version."
}
...
variable "mod_dependency” {
  default     = null
  description = "Dependence variabe binds all AWS resources allocated by this module, dependent modules reference this variable." 
}
